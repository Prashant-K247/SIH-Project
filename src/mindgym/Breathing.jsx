...
export default function Breathing() {
  ...
  {/* Animated Circle */}
  <div
    className={`w-56 h-56 rounded-full bg-[#2A3A4F] 
  ...
  {/* Subtitle */}
  <p className="mt-6 text-xl italic text-gray-300 text-center max-w-md leading-relaxed">
