...
function Home() {
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-[max-content_1fr] gap-5">
        <div className="max-w-sm w-full bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          <div className="p-5">
            <Link to="/mindgym">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-950">
                Mind Gym
              </h5>
            </Link>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-lg flex flex-col justify-center">
          <div className="">
            <Link to="/">
            <img
    ...
    <div className='grid grid-cols-2 gap-5'>
         {/* 3rd caard */}
      <div className="bg-white border h-80 max-w-200 border-gray-200 rounded-lg shadow-lg  flex flex-col justify-center">
        <div className="">
          <Link to="/Blogs">
            <img
      ...
      {/* 4th */}
      <div className="bg-white border max-w-200 h-80 border-gray-200 rounded-lg shadow-lg flex flex-col justify-center">
        <div className="">
          <Link to="/games">
            <img
              className="rounded-t-lg w-full h-50 object-cover mb-2"
          ...
          <div className='p-5'>
            <Link to="/games">
            <h3 className="mb-2 text-2xl font-bold tracking-tight text-gray-950">
