...
function Community() {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      {/* Header */}
      <div className="bg-gray-800 border-b border-gray-700 flex items-center px-8 py-6">
      ...
      <div className="flex flex-1 px-4 py-8 gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">MrEnd254</span>
              <span className="text-xs text-gray-500">2 hr. ago</span>
              <span className="bg-gray-700 text-xs px-2 py-1 rounded font-bold text-gray-300 ml-2">Giving Advice</span>
            </div>
            ...
            <div className="pl-1 border-l-2 border-pink-400 text-sm text-gray-200">
          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">Mrintresting-234</span>
              <span className="text-xs text-gray-500">7 hr. ago</span>
              <span className="bg-gray-700 text-xs px-2 py-1 rounded font-bold text-gray-300 ml-2">Giving Advice</span>
            </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-gray-500">9 hr. ago</span>
              <span className="bg-gray-700 text-xs px-2 py-1 rounded font-bold text-gray-300 ml-2">Giving Advice</span>
            </div>
        ...
        {/* Right Sidebar */}
        <div className="w-96">
          <div className="bg-gray-800 rounded-lg px-6 py-5 mb-6">
            ...
            <div className="flex gap-6 mt-2 text-xs text-gray-300">
              <span>67K <span className="text-gray-400">Weekly visitors</span></span>
              <span>1.2K <span className="text-gray-400">Weekly contributions</span></span>
            </div>
          </div>
